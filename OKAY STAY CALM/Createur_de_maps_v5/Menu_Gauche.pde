...
void MenuAffichage() {
  ...
  if (couleurSelect == roche ) fill(140, 157, 154);   //Bloc de selection
  ...
  if (mousePressed == true && mouseButton == LEFT && mouseX > largMenu/4 -25 && mouseX < largMenu/4 +25 && mouseY > 300-25 && mouseY < 300+25) {       //Boutton Recup (Gauche)
    GrilleRecup();
  }
  if (mousePressed == true && mouseButton == LEFT && mouseX > largMenu/4*3 -25 && mouseX < largMenu/4*3 +25 && mouseY > 300-25 && mouseY < 300+25) {   //Boutton Save (droite)
    GrilleSave();
  }
